$(document).ready(function() {
  var $category_show = $("#main-category-toggler"), $main_category = $("#main-category"), $main_category_toggler_close = $("#main-category-toggler-close"), $main_category_toggler = $("#main-category-toggler");
